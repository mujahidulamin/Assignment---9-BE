...
//faq service
const addFaq = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const faq = yield faq_model_1.Faq.create(data);
    return faq;
});
const getAllFaq = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield faq_model_1.Faq.find(whereConditions)
        .sort(sortConditions)
        .skip(skip)
        .limit(limit);
    const total = yield faq_model_1.Faq.countDocuments(whereConditions);
    return {
        meta: {
            page,
            limit,
...
const updateFaq = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const updatedFaq = yield faq_model_1.Faq.findOneAndUpdate({ _id: id }, payload, {
        new: true,
    });
    return updatedFaq;
});
